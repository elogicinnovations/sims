...
const CreateModal = ({ show, handleClose, reloadTable }) => {
  ...
  const createCompany = async (e) => {
    ...
    if (hasError) {
      swal("Validation Error", "Company Name are required.", "warning");
      return;
    }
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        swal("Duplicate Entry", "This company already exists.", "info");
      }
    } catch (err) {
  ...
  return (
    <div>
      <Modal
        ...
        animation={false}
      >
        <Form noValidate onSubmit={createCompany}>
